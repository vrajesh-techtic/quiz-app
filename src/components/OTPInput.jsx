...
const OTPInput = ({ length = 4,
    ...
    const handleChange = async (index, e) => {
        ...
        if (combinedOtp.length === length) {
            ...
            setisVerified(() => onOtpSubmit(combinedOtp));
    ...
    return (
        <>
            ...
            <div className=" bg-white  py-2 rounded-lg w-[500px] h-[70px] flex items-center justify-center text-red-400  mt-8 text-xl ">
                ...
                {displayMsg ?
                    <span className="text-center">Please Check your e-mail address. You have might received an OTP for Verification.</span>
                    : !isVerified ? <span className="text-center">Please Enter correct OTP !</span> : null}
